...
if testing:
    ...
    drive_activity_log = '/home/mmv/mining/plot_manager/drive_monitor.iostat'
else:
    ...
    status_file = '/media/mmv/mining/plot_manager/local_transfer_job_running'
    drive_activity_test = '/media/mmv/mining/plot_manager/chianas/check_drive_activity.sh'
    drive_activity_log = '/media/mmv/mining/plot_manager/logs/drive_monitor.iostat'
